...
class TransactionServiceTest {
    ...
    void useBalance_AcoountNotFound() {
        //given
        AccountUser user = AccountUser.builder()
                /*BaseEntitiy
                .id(12L) */
    ...
    void deleteAccountSucess_AlreadyUnregistered() {
        AccountUser pobi = AccountUser.builder()
                /*BaseEntitiy
                .id(12L) */
                .name("Pobi").build();
    ...
    void successCancelBalance () {
        ...
        //when
        TransactionDto transactionDto = transactionService.cancelBalance("tranactionId", "1000000012", CANCEL_AMOUNT);
    ...
    void cancelBalance_AcoountNotFound() {
        //given
        given(transactionRepository.findByTransactionId(anyString()))
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.cancelBalance("tranactionId", "10000000000", 1000L));
    ...
    void cancelBalance_UserUnMatch() {
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.cancelBalance("tranactionId", "10000000000", CANCEL_AMOUNT));
    ...
    void queryTransaction_TransactionNotFound() {
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.queryTransaction("tranactionId"));
